...
inline namespace {
    Camera camera {
        ...
        .rotation = {0.32f, 3.34f, 0.0f}  // Убраны лишние скобки
    };
...
void initialize(VkCommandBuffer cmd) {
    ...
    // ТОЧНО ТАКИЕ ЖЕ ТОЧЕЧНЫЕ ИСТОЧНИКИ КАК В 3 ЛАБЕ!
    point_lights.clear();
    point_lights.emplace_back(PointLight{{2.5f, -1.2f, -0.45f}, 4.0f, {1.0f, 0.95f, 0.85f}, 0.0f});
    point_lights.emplace_back(PointLight{{0.0f, -0.5f, -0.2f}, 4.0f, {1.0f, 0.90f, 0.80f}, 0.0f});
    point_lights.emplace_back(PointLight{{-2.2f, -1.1f, -0.25f}, 4.0f, {0.95f, 0.90f, 1.0f}, 0.0f});
}
