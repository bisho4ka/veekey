...
namespace {
    ...
    void initialize(VkCommandBuffer cmd) {
        ...
        
        {
            ...
            // Лейаут для сцены (uniforms и storage буферы)
            {
            ...
            // Лейаут для материалов (текстуры)
            {
        ...
        // Текстура-заглушка на случай отсутствия файла
        {
        ...
        // Обновление дескрипторов материалов
